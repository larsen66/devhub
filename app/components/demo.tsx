...
export function Demo({ isDesktop }: { isDesktop: boolean }) {
	...
	return (
		<motion.div 
			...
			transition={{ duration: isDesktop ? 2 : 1, ease: "easeOut" }}
		>
			...
			<div className="relative -mt-32 h-96 w-full overflow-hidden [mask-image:radial-gradient(circle_at_50%_50%,white,transparent)]">
